        ...
        <div className='p-5 border rounded-3xl bg-secondary'>
            ...
            {sessionDetail && (
                <div className='flex items-center flex-col mt-10'>
                    {sessionDetail.selectedDoctor?.image && sessionDetail.selectedDoctor.image.trim() !== '' ? (
                        <Image
                        ...
                        <div className='h-[100px] w-[100px] rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-2xl'>
